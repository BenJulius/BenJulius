...
### [AD Password Audit](https://github.com/BenJulius/AD-Password-Audit)
A PowerShell-based security tool designed to audit Active Directory user accounts against known weak password lists.
